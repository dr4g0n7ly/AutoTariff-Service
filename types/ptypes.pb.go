...
type DistanceAggregateRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DistanceAggregateRequest) Reset() {
	*x = DistanceAggregateRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DistanceAggregateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DistanceAggregateRequest) ProtoMessage() {}

func (x *DistanceAggregateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_types_ptypes_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DistanceAggregateRequest.ProtoReflect.Descriptor instead.
func (*DistanceAggregateRequest) Descriptor() ([]byte, []int) {
	return file_types_ptypes_proto_rawDescGZIP(), []int{1}
}

func (x *DistanceAggregateRequest) GetObuID() int32 {
	if x != nil {
		return x.ObuID
	}
	return 0
...
func (x *DistanceAggregateRequest) GetValue() float64 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *DistanceAggregateRequest) GetUnix() int64 {
	if x != nil {
		return x.Unix
	}
	return 0
...
var file_types_ptypes_proto_rawDesc = []byte{
	...
	0x44, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74,
	...
	,
...
var file_types_ptypes_proto_goTypes = []interface{}{
	(*None)(nil),                     // 0: None
	(*DistanceAggregateRequest)(nil), // 1: DistanceAggregateRequest
}
var file_types_ptypes_proto_depIdxs = []int32{
	1, // 0: DistanceAggregator.AggregateDistance:input_type -> DistanceAggregateRequest
...
func file_types_ptypes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_types_ptypes_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DistanceAggregateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

...
type DistanceAggregatorClient interface {
	AggregateDistance(ctx context.Context, in *DistanceAggregateRequest, opts ...grpc.CallOption) (*None, error)
}
...
func (c *distanceAggregatorClient) AggregateDistance(ctx context.Context, in *DistanceAggregateRequest, opts ...grpc.CallOption) (*None, error) {
	out := new(None)
	err := c.cc.Invoke(ctx, "/DistanceAggregator/AggregateDistance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DistanceAggregatorServer interface {
	AggregateDistance(context.Context, *DistanceAggregateRequest) (*None, error)
...
func (UnimplementedDistanceAggregatorServer) AggregateDistance(context.Context, *DistanceAggregateRequest) (*None, error) {
...
func _DistanceAggregator_AggregateDistance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DistanceAggregateRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/DistanceAggregator/AggregateDistance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DistanceAggregatorServer).AggregateDistance(ctx, req.(*DistanceAggregateRequest))
	}
